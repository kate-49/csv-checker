    ...
    public function testRunThroughAllCvsToCollectData()
    {
        ...
        $expectedCV2 = (new CV)->newCV(
            ...
            [
                ...
                ' This meant better database capacity and improved performance without additional business costs',
                ' ',
                ...
                '* Handling document upload to a new microservice',
                ' I also automated letters via the Notify Api',
        ...
        $this->assertEquals(
            [
                ...
                'test_cv.txt' => [
                    ...
                    ' My favourite reports are made in SQL and use some PHP'
                ],
            ],
            $result
        );
